...
#include "simple_local_flags.inc"
    ...
    type :: parameters
        ...
        !!!
        character(len=3)          :: multipick='no'       !< whether to repeat pick program for multiple molecular diameters
        !!!
        ...
        !!!
        integer :: nmoldiams=1         !< # of moldiams tested in multipick
        !!!
        integer :: noris=0
        ...
        real    :: moldiam_up=200.     !< upper bound molecular diameter, used only in multipick
        real    :: moment=0.
    ...
    contains
        ...
        subroutine new( self, cline, silent )
            ...
            call check_carg('multipick',      self%multipick)
            ...
            call check_rarg('moldiam_up',     self%moldiam_up)
